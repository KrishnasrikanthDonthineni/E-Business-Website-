...
//===========================================
   ...
   static int Port_to_Server = 11014;
   static int Port_from_Server = 11015;
  ...
  //**************
   ...
   String QflagName = "f-Qc.dat"; // Lock Flag-File for Question (DATA at Client to send to Server)
   String QnameAtC = "Qc.dat";   // Question-File name (of DATA=QUESTION) at Client to send to Server
   String QnameAtS = "Qs.dat";   // Question-File name (of DATA=QUESTION) to be GIVEN to the Server 

   String AflagName = "f-Ac.dat"; // Lock Flag-File for ANSWER (DATA at Client to send to Server)
    String AnameAtC = "BAc.dat";  // Answer-File name used to write the DATA=ANSWER 
...
//=========================================================================
 ...
 public static void main (String args[]) {
      ...
      if (args.length == 1) new BankClient (args[0]);
      else new BankClient (null);
