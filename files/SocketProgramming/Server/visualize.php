        ...
        <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
          ...
          <div class="table-responsive">
            <table class="table">
              <thead>
                <tr>
                  <th scope="col" class="border-0 bg-light">
                    <div class="p-2 px-3 text-uppercase">Customer_Type</div>
                  </th>
                  <th scope="col" class="border-0 bg-light">
              ...
              <tbody>
<?php
$result=mysqli_query($db,"select * from visualize");
                  ...
                  <th scope="row" class="border-0">
                    <div class="p-2">
                      ...
                      <div class="ml-3 d-inline-block align-middle">
                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle"><?php echo $row["customer_type"]; ?></a></span>
                      </div>
                    </div>
                  </th>
