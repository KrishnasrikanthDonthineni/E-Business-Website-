...
<!-- Write your comments here -->   
                <br />  
             <p>	The Ports to connect IT service-1 is Port1 :-11014 (Receiving The data from you)</p> 
	<p>Port2 :-11015(Sending The confirmation data from IT-Service)</p> 
	<p>The format for the Order/request file is cutomer_type,item_name,quantity,total_price.</p> 
	<p> Data should be separated by ,  (comma)</p> 
	<p>The Status reply format o (Zero)if successful and 1 (one)if it is a failure
 </p> 
               <?php  
